...
There are large amounts of capital on Ethereum, that would love to be deployed in a productive way. At the same time, many small businesses in low-income countries are capital constrained, meaning that they could be a lot more productive if they just had access to a bit more capital. We think of this as _the worlds largest capital misallocation problem_ - and blockchain could play a huge part in solving it.

Existing online and offline lenders in low-income countries charge incredibly high interest rates - sometimes more than a 100% per year. For traditional microfinance lenders, who have relatively high repayment rates, this is caused by high operating costs relative to the small loan sizes. For online lenders, with low operating costs, this is caused by an inability to effectively screen and incentivize repayment. Additionally in both cases, a lot of the capital initially comes from high-income countries, and is handed through many middlemen before it ultimately arrives at the borrower - each one taking their cut, increasing the cost for the borrower futher. Wouldn't it be great if anyone with spare cash could _directly_ invest into a capital constrained small business anywhere in the world, with strong enough incentives for repayment?

We're not there yet: as of today, loans on the blockchain must always be overcollateralized - otherwise, what stops you from just defaulting and creating a new account? These types of loans might be useful to traders, but are pointless for capital constrained small businesses. Using the logic of this contract however, you can now create a unique-for-life ID for anyone who lives in a country with an online ID database - which is being rolled out in many African nations, for example. Immediately, this creates repayment incentives for loans from the blockchain, even without collateral: any future lender (on- and off-chain) could check if you did not repay your loans a couple times, and it would be hard to get another loan from them. Combine this with Open Contracts' ability to verify e.g. your repayment rates with existing online lenders, and we start to see how "the worlds largest capital misallocation problem" starts to sound solvable!
